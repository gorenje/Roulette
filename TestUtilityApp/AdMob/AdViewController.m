...
- (NSString *)publisherId {
  return @"a149c8a190b1ad3"; // this should be prefilled; if not, get it from www.admob.com
}

- (UIColor *)adBackgroundColor {
  return [UIColor colorWithRed:0.353 green:0.675 blue:0.278 alpha:1];
}

- (UIColor *)adTextColor {
  return [UIColor colorWithRed:0.275 green:0.29 blue:0.973 alpha:1];
}
